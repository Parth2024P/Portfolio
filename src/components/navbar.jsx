  ...
  return (
    ...
    >
      ...
      <div className="w-[90vw] max-w-xs md:max-w-4xl mx-auto">
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-3 md:px-6 md:py-2">
          <div className="flex items-center justify-between">
            {<span className="text-white font-bold text-xl">Parth</span>}
            <a
              href="/"
